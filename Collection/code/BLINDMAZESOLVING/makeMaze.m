...
% This function generates random mazes with sidewalls given complexity 'n'
% Free code from adapted from http://rosettacode.org/wiki/Maze_generation
% Maze patterns of 0, 2, -1, -2 adapted for BlindMazeSolving.
% Michael Umeano... 05/02/2015
