...
% TODO: ask sandor these two questions, show images of the problem.  HOw long will I allow my program to run?  How about to 5 million nodes?  Should also make the program print the minimum value.
%
%
...
%\end{algorithmic}
  ...
  We can accomplish with discrete inputs,
  we can move a 
