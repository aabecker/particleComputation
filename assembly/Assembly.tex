...
We present hardware results on a milli-scale, magnetically-actuated system.
%both a macro-scale, gravity-based system and a milli-scale, magnetically actuated system.
