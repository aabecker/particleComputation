...
\begin{figure}
\centering
\subfloat[unit moves = 0\label{cw_10}]{%
  \includegraphics[width=0.45\textwidth]{fig1b2.pdf}%
  }\par
\subfloat[unit moves = 18\label{cw_25}]{%
  \includegraphics[width=0.45\textwidth]{NewFig1b1.pdf}%
  }\par        
\subfloat[unit moves = 28. Parallel Assembly\label{cw_50}]{%
  \includegraphics[width=0.45\textwidth]{Fig1c3.pdf}%
  }
\caption{A seven tile factory. Each particle is actuated simultaneously by the same global field. The factory is designed so each clockwise control input assembles another component.}
\label{TS}
\end{figure}
