...
\end{overpic}\\ \vspace{-1em}
\caption{\label{fig:24Tilefactory}A twenty-four tile factory, step 82 for a `\#' shape and a twenty-one tile factory for a spiral (this is a vector graphic -- zoom in for details).
}
\end{figure}
