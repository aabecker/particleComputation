function [factoryObstacleAdditionArray, align] = DirDown(hopper,partXY,  tileXY)
% DIRDOWN function for the tile added through down move
...
hopper(end-1:end, 1:end) = obs; %define the bottom obstacle to stop the "downward" motion of the part                       
%%%%%%%%%Add Left Obstacle%%%%%%%%%
