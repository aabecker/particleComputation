...
obs_col=3; %Start column position from third column
    ...
    for totalitr=1:36 %obstacle has 36 locations
        ...
        path(2:8,2:9) = 2; %Put red particles in the top seven rows of the region
