function [OneStage]= Up(subfactory,align2,align3,stage)
%Function for joining tiles from Up move
if nargin<1
    align2 =7;
    align3 =10;
...
OneStage(align3,3)=obs; %Add obstacle to stop right motion
OneStage=vertcat(OneStage,zeros(5,stage*4+1+3));
