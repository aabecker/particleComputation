...
Fig.~\ref{fig:macroresults} shows results of experimentation for a three tile row and column polyominoes.  Success rate is high when the number of sliders in each hopper is small.
